...
BASE_MODEL_DIR = "/root/out/llama31_8b_instruct_sparsegpt_2of4/dense"

# Adapter dir produced by finetune script (contains adapter_model.safetensors + adapter_config.json)
ADAPTER_DIR = "/root/out/pruned-llama31-8b-instruct-sft-lora"

# Output dir for merged full model
MERGED_OUT_DIR = "/root/out/llama-31-8b-instruct-pruned-sft-merged-bf16"
